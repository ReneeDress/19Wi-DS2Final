...
int main()
{
    ...
    switch (c) {
        case 1: {
            cout << "测试文件描述：考核题目提供输入样例1。" << endl;
            break;
        }
        case 2: {
            cout << "测试文件描述：考核题目提供输入样例2。" << endl;
            break;
        }
        case 3: {
            cout << "测试文件描述：两个点之间有多条路径的最小安全值的最大值相等，输出其中路径上道路条数最少的一条。" << endl;
            break;
        }
        case 4: {
            cout << "测试文件描述：两个点之间有多条路径的最小安全值的最大值相等，道路条数一样，输出终点的前驱结点序号相对小的路径。" << endl;
            break;
        }
        case 5: {
            cout << "测试文件描述：两个点之间有多条路径的最小安全值的最大值相等，共三条，其中有两条道路条数也一样。" << endl;
            break;
        }
        case 6: {
            cout << "测试文件描述：五结点无向网完全图。" << endl;
            break;
        }
        case 7: {
            cout << "测试文件描述：不存在的文件。" << endl;
            break;
        }
        case 8: {
            cout << "测试文件描述：空无向网或无边图(空文件结果相同)。" << endl;
            break;
        }
        case 9: {
            cout << "测试文件描述：结点数大于 100。" << endl;
            break;
        }
        case 10: {
            cout << "测试文件描述：边信息条数大于 1000。" << endl;
            break;
        }
        case 11: {
            cout << "测试文件描述：结点数100。" << endl;
            break;
        }
        default: {
            cout << "不存在此文件编号。" << endl;
